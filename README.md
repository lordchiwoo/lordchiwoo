...
- DevOps:
    ...
    - Github/Gitlab CI/CD 파이프라인을 활용하여 배포 프로세스 자동화 및 안정화 기여
- 협업: 기획/설계 단계 리딩
...
- AI 기반 개발 생산성 향상
    - Cursor, Antigravity, Claude Code 등 최신 AI 코딩 도구를 적극 활용하여 보일러플레이트 코드 자동 생성, 복잡한 로직 리팩토링 제안, 효율적인 디버깅 지원 등을 통해 개발 생산성 향상 및 개발 주기 단축
    - 특히 Spec/Plan 문서와 소스코드 전반에 걸친 AI 산출물을 빠르게 스키밍하고 부족한 부분과 잘된 부분을 민첩하게 캐치하여 개선 루프를 이끌어내는 장점이 있으며, 새로운 기술 습득 및 적용에 능숙함.
...
### (주)비에네스소프트 (프리랜서) *2026.06 - 재직중*
*기술 스택: Java(21), Spring Boot 4.1, Postgre SQL*
- H자동차 기업 국내판매시스템 차세대 프로젝트
- 진행중

---

### 컨씨플레이 (프리랜서) *2025.11 - 2026.05*
